...
<body id="top">
                    ...
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                ...
                                <li><a href="#Packs"target="_blank"class="btn-white btn-small">Welcom      ,<?php echo $_SESSION['name']; ?></a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="navicon">
  ...
  <script>
    ...
    <p>To start your free Trial  please click   <a href="sign.php" target="_parent">here </a>  </p>
    </div>
		<div class="copy-rights">
